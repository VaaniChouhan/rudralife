...
export default function App() {
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (e) => {
      const elements = document.querySelectorAll('.btn-gold, .btn-outline-white, .astro-wizard-card');
      elements.forEach(el => {
        const rect = el.getBoundingClientRect();
...
<section className="dark hero-banner-sec" id="s2" data-bg="13,10,6">
  <div className="inner">
    ...
    <div style={{textAlign: 'center', marginTop: '22px'}} className="reveal">
...
<section className="dark" id="s4" data-bg="10,8,4">
  <div className="inner">
    <div className="sh reveal">
      ...
      <h2 className="display">How Would You Like<br />To Begin?</h2>
      <p>Every journey is unique. Discover the path that resonates with you.</p>
    </div>
    <div className="journey-grid reveal">
      <a href="#" className="jcard">
        <span className="jcard-icon"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.2em',height:'1.2em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="2"/><line x1="12" y1="2" x2="12" y2="22" stroke="currentColor" strokeWidth="2"/><line x1="12" y1="12" x2="5" y2="19" stroke="currentColor" strokeWidth="2"/><line x1="12" y1="12" x2="19" y2="19" stroke="currentColor" strokeWidth="2"/></svg></span>
        <h3>Seeking Peace</h3>
        <p>Find clarity and calm through the right Rudraksha</p>
        <span className="arrow">Explore →</span>
      </a>
      <a href="#" className="jcard">
        <span className="jcard-icon"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.2em',height:'1.2em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><path fill="none" stroke="currentColor" strokeWidth="2" d="M12 2L4 5v6c0 5.5 3.5 10.1 8 11 4.5-.9 8-5.5 8-11V5l-8-3zm0 17.9c-3.1-.9-5.5-4.5-5.5-8.9V6.2L12 4.1l5.5 2.1v4.8c0 4.4-2.4 8-5.5 8.9z"/></svg></span>
      ...
      <a href="#" className="jcard">
        <span className="jcard-icon"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.2em',height:'1.2em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="2"/><circle cx="12" cy="12" r="6" fill="none" stroke="currentColor" strokeWidth="2"/><circle cx="12" cy="12" r="2" fill="currentColor"/></svg></span>
      ...
      <a href="#" className="jcard" style={{gridColumn: '1 / -1', background: 'rgba(196,154,60,0.08)', borderColor: 'rgba(196,154,60,0.35)'}}>
        <span className="jcard-icon"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.1em',height:'1.1em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><path fill="currentColor" d="M5 16h14a1 1 0 0 0 1-1l-2-6-4 4-2-6-2 6-4-4-2 6a1 1 0 0 0 1 1zm-1 2h16v2H4v-2z"/></svg></span>
...
<section className="light" id="s5" data-bg="250,246,238">
  <div className="inner">
    <div className="sh reveal">
      ...
      <p>Over a century of combined experience dedicated to authentic Rudraksha guidance.</p>
    </div>
    <div className="stat6 reveal">
...
<section className="light" id="s7" data-bg="250,246,238">
  <div className="inner">
    <div className="sh reveal">
      ...
      <h2 className="display" style={{color: 'var(--black)'}}>New To Rudraksha?<br />Start With Confidence.</h2>
      <p>Guidance, exclusive benefits and expert support for your very first step.</p>
    </div>
    <div className="ftcard reveal">
      <span className="gift"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.3em',height:'1.3em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><path fill="currentColor" d="M20 6h-2.18c.11-.31.18-.65.18-1a2.5 2.5 0 0 0-5-0.5L12 6l-1-1.5a2.5 2.5 0 0 0-5 0.5c0 .35.07.69.18 1H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-8-1.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5c0 .41-.16.78-.44 1.06L12 8V4.5zm-4.5-1.5C8.33 3 9 3.67 9 4.5V8H6.44c-.28-.28-.44-.65-.44-1.06 0-.83.67-1.5 1.5-1.5zM4 8h7v10H4V8zm16 10h-7V8h7v10z"/></svg></span>
...
<section className="light" id="s9" data-bg="250,246,238">
  <div className="inner">
    <div className="sh reveal">
      ...
      <p>India's first dedicated Rudraksha testing laboratory — where ancient beads meet modern science.</p>
    </div>
...
{/* ══════════════════════════════════════════
     NEW SECTION · SIDDHA MALA™ FLAGSHIP FEATURE
══════════════════════════════════════════ */}
<section className="dark" id="s-siddha-mala" data-bg="18,12,6">
  <div className="inner">
    <div className="sh reveal">
      ...
      <h2 className="display">The World's Most<br />Powerful Mala.</h2>
...
<section className="light" id="s16" data-bg="250,246,238">
  <div className="inner">
    <div className="sh reveal">
      ...
      <h2 className="display" style={{color: 'var(--black)'}}>Real Journeys.<br />Real Transformations.</h2>
      <p>Discover how Rudraksha has quietly changed thousands of lives.</p>
    </div>
  </div>
  <div className="stories-scroll reveal">
    <div className="story-card">
      <div className="story-img"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.1em',height:'1.1em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><path fill="currentColor" d="M12 3a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zm0 6c-3 0-5 2.5-5 5.5s1 4.5 3 4.5h4c2 0 3-1.5 3-4.5S15 9 12 9zm-1 9v2h2v-2h-2z"/></svg></div>
    ...
    <div className="story-card">
      <div className="story-img"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.1em',height:'1.1em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><path fill="currentColor" d="M20 6h-4V4c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-10-2h4v2h-4V4zm10 14H4V8h16v10z"/></svg></div>
      <div className="story-body">
    ...
    <div className="story-card">
      <div className="story-img"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.1em',height:'1.1em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><path fill="currentColor" d="M12 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm5.5 11h-11C5.1 13 4 14.1 4 15.5V22h16v-6.5c0-1.4-1.1-2.5-2.5-2.5z"/></svg></div>
      <div className="story-body">
    ...
    <div className="story-card">
      <div className="story-img"><svg className="svg-icon" viewBox="0 0 24 24" style={{width:'1.1em',height:'1.1em',display:'inline-block',verticalAlign:'middle',marginRight:'6px'}}><path fill="currentColor" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg></div>
      <div className="story-body">
...
<section className="dark" id="s17" data-bg="13,10,6">
  <div className="inner">
    <div className="sh reveal">
      ...
      <h2 className="display">25 Years Of Serving<br />Spiritual Seekers.</h2>
...
<section className="dark" id="s25" data-bg="13,10,6">
  <div className="inner">
    <div className="sh reveal">
      ...
      <p>Authentic research and spiritual wisdom captured across bestselling volumes and our knowledge center.</p>
    </div>
  </div>
  ...
  {/* Knowledge Center */}
  <div className="inner" style={{marginTop: '36px'}}>
    <div className="divider reveal" style={{marginBottom: '20px'}}>
